...
@section('content')
  <div class="container">
    <div class="text-center mb-5">
      <h5 class="text-center my-3">Ubah Data Keluarga</h5>
      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $family->name) }}" required>
            @error('name')
          ...
          <div class="mb-4">
            ...
            <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" required>
              <option value="Male" {{ old('gender', $family->gender) === 'Male' ? 'selected' : '' }}>Laki-laki</option>
              <option value="Female" {{ old('gender', $family->gender) === 'Female' ? 'selected' : '' }}>Perempuan</option>
            </select>
            @error('gender')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          ...
          <div class="mb-4">
            ...
            <select class="form-select" id="parent_id" name="parent_id" data-placeholder="Pilih Orang Tua" style="width: 100%;">
              ...
              @foreach ($families as $item)
                @if (old('parent_id', $family->parent_id) == $item->id)
